...
_SIGNING_SECRET = os.getenv("orbitq_SIGNING_SECRET", "")
if not _SIGNING_SECRET:
    warnings.warn(
        "orbitq_SIGNING_SECRET is not set. Using an insecure empty secret. "
...
_TOKEN_TTL_SECONDS = int(os.getenv("orbitq_TOKEN_TTL", "3600"))
...
# Audit Trail
_AUDIT_LOG_PATH = os.getenv("orbitq_AUDIT_LOG", "audit.log")
