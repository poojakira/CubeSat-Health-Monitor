...
def _pkg_dir() -> str:
    spec = importlib.util.find_spec("orbitq")
...
def cmd_stress_test(args):
    ...
    from orbitq.simulator.multi_cubesat_stress import MultiCubeSatStressTest
...
def cmd_retrain(args):
    ...
    logging.basicConfig(level=logging.INFO, format="%(asctime)s | %(levelname)s | %(message)s")
    from orbitq.ensemble.engine import AnomalyEngine
    from orbitq.mlflow_tracking.retraining_pipeline import RetrainingPipeline
